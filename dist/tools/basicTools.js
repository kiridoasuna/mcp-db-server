 ...
 * 注册基础工具
 */
export function registerBasicTools(server, registeredTools) {
    console.log('Registering basic tools...');
    // 加法计算工具
    server.registerTool('calculate-addition', {
    ...
    // 加班申请工具
    server.registerTool('overtime-application', {
    ...
    // Chuck Norris笑话工具
    server.registerTool('get-chuck-joke', {
